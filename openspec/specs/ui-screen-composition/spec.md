...
- **THEN** it SHALL contain sections for calendar pairing (source and target dropdowns), event naming (text field), schedule (interval dropdown and sync enabled toggle)
